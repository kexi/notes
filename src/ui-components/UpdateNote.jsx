...
export default function UpdateNote(props) {
  ...
  const textFieldThreeOneSixZeroTwoFourSevenEightOnClick =
    useDataStoreUpdateAction({
      fields: { title: textFieldThreeOneSixZeroTwoFourSevenEightValue },
      id: note?.id,
      model: Note,
      schema: schema,
    });
      ...
      >
        ...
        >
          <TextField
            ...
            onClick={() => {
              textFieldThreeOneSixZeroTwoFourSevenEightOnClick();
            }}
            onChange={(event) => {
              setTextFieldThreeOneSixZeroTwoFourSevenEightValue(
                event.target.value
