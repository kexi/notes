...
export default function CreateNote(props) {
  ...
  const textFieldThreeOneSixZeroTwoFourEightFiveOnClick =
    useDataStoreCreateAction({
      fields: { title: textFieldThreeOneSixZeroTwoFourEightFiveValue },
      model: Note,
      schema: schema,
    });
  return (
    ...
    >
      ...
      >
        ...
        <TextField
          ...
          onClick={() => {
            textFieldThreeOneSixZeroTwoFourEightFiveOnClick();
          }}
          onChange={(event) => {
            setTextFieldThreeOneSixZeroTwoFourEightFiveValue(
              event.target.value
